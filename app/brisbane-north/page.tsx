...
export const metadata: Metadata = {
  ...
  description: 'Pet cremation services for Brisbane North suburbs. Private pet cremation services for Brisbane suburbs.',
};
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-zinc-900">
      <div className="mx-auto max-w-4xl px-6 py-16">
        ...
        <p className="mt-4 text-xl text-zinc-600">We provide pet cremation services serving Brisbane North suburbs.</p>
