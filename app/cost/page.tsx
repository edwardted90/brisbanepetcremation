...
export const metadata: Metadata = {
  ...
  description: 'Find out how much pet cremation costs in Brisbane. Compare pricing from local providers for dogs, cats and other pets. Get transparent quotes.',
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-zinc-900">
      <div className="mx-auto max-w-4xl px-6 py-16">
        ...
        <p className="mt-4 text-xl text-zinc-600">Pricing varies between providers. Compare options to find the right service for your budget.</p>
        ...
        <div className="mt-12 space-y-8">
          ...
          <div className="rounded-2xl border border-zinc-200 p-8">
            ...
            <p className="mt-2 text-zinc-600">Larger dogs typically cost more due to size. Multiple providers offer competitive rates.</p>
          </div>
        ...
        <div className="mt-16 rounded-2xl bg-zinc-50 p-10 text-center">
          <p className="text-lg">Prices vary between providers. The best way to get accurate pricing is to compare multiple quotes.</p>
